...
namespace DotNetExperiment.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class GoogleTokenValidation : ControllerBase
    {
        private const string GoogleApiTokenInfoUrl = "https://www.googleapis.com/oauth2/v3/tokeninfo?id_token={0}";

        private readonly ILogger<GoogleTokenValidation> _logger;

        public GoogleTokenValidation(ILogger<GoogleTokenValidation> logger)
        {
            _logger = logger;
        }

        [HttpGet]
        public object Get(string providerToken)
        {
